...
$about_heading = pack3_field('about_heading', 'Albany Pack 3 has a long and proud history of service to Albany\'s youth');
$about_content = pack3_field('about_content', '<p>Pack 3 is chartered by the American Legion Post 292 of Albany and is part of the Herms District of the Golden Gate Council, Boy Scouts of America.</p><p>We are an inclusive pack that represents the diversity of our community. We are strongly committed to creating a welcoming environment for all children who wish to join our Pack.</p><p>We are proud to be designated as an <strong>Inclusive Unit by Scouts for Equality</strong> and our leaders wear the "Scouts for Equality" badge on their uniforms.</p>');
$about_quote   = pack3_field('about_quote', 'Serving Albany\'s youth and community since 1935.');
$about_image   = pack3_field('about_image');

$theme_uri = get_template_directory_uri();
$image_url = $about_image ? $about_image : $theme_uri . '/images/welcome-group.jpg';
?>
            ...
            <div class="welcome-grid">
                <div class="welcome-text">
                    ...
                    <div class="highlight-box">
                        <p>"<?php echo esc_html($about_quote); ?>"</p>
                    </div>
                    <?php endif; ?>
                </div>
                <div class="welcome-image">
                    <img src="<?php echo esc_url($image_url); ?>" alt="Pack 3 families at community event">
                </div>
            </div>
        </div>
    </section>
